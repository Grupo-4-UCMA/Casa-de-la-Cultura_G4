...
Una sola aprobación es suficiente para que el PR pueda mergearse. **Sé constructivo y específico** en los comentarios: en vez de *"esto está mal"*, mejor *"creo que aquí habría que validar que el ISBN no sea nulo, sino el script peta con los registros incompletos del CSV"*.
